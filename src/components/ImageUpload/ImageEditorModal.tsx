...
function ImageEditorModal({
  ...
  const discardChangesButtonRef = React.useRef<HTMLButtonElement>(null);

  // not sure how to make this work with the image editor
  // useKeepFocusInModal({
  //   modalRef: modalRef,
  //   lastElemRef: discardChangesButtonRef,
  // });
